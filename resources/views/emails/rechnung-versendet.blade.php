...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>
                anbei erhalten Sie unsere Rechnung <strong>{{ $rechnung->rechnungsnummer }}</strong>
                vom {{ $rechnung->datum->format('d.m.Y') }}.
            </p>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:right">{{ number_format($pos->nettobetrag, 2, ',', '.') }} €</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
            ...
            <p>
                Zahlbar bis zum <strong>{{ $rechnung->faelligkeitsdatum->format('d.m.Y') }}</strong>.
            </p>
            ...
            @if($rechnung->notizen)
            <div class="note">{{ $rechnung->notizen }}</div>
            @endif
        </div>
