...
<head>
    ...
    <title>Kundenbereich — Anmelden</title>
    ...
    <div class="login">
        <div class="login-card">
            <a href="/" class="login-logo">
                ...
                <span class="login-logo-text">Kundenbereich</span>
            </a>

            <div class="login-title">Willkommen zurück</div>
            <div class="login-sub">Melde dich an, um deinen Kundenbereich zu öffnen</div>
            ...
            <form method="POST" action="{{ route('customer.login') }}">
                ...
                <div class="login-field" style="flex-direction:row;align-items:center;gap:var(--space-2);margin-bottom:0">
                    <input type="checkbox" id="remember" name="remember" style="accent-color:var(--color-primary)">
                    <label for="remember" style="font-size:var(--text-sm);color:var(--color-text-muted);margin:0">Angemeldet bleiben</label>
                </div>
